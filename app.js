...
const frollSocialAbi = [
  ...
  "function commentOnPost(uint256 postId, string message)",
  "function comments(uint256, uint256) view returns (address commenter, string message, uint256 timestamp)",
  "function createPost(string title, string content, string media)",
  "function follow(address user)",
  "function followers(address, uint256) view returns (address)",
  "function following(address, uint256) view returns (address)",
  "function frollToken() view returns (address)",
  "function getComments(uint256 postId) view returns ((address commenter, string message, uint256 timestamp)[])",
  ...
  "function register(string name, string bio, string avatarUrl, string website)",
